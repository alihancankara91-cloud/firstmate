...
The separate queued-escalation predicate can still block for a home-local open decision or blocker, but untracked harness work creates neither that event nor its queue record.
