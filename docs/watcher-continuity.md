...
It also refuses a bounded turn end while a home-local queued signal maps to a still-open decision or blocker, independently of watcher health; [`turnend-guard.md`](turnend-guard.md) owns that predicate.
