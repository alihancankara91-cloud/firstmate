...
- [docs/turnend-guard.md](docs/turnend-guard.md) - the primary session's structural turn-end backstop for undrained escalations and missing supervision: verified per-harness hook mechanisms, scoping, loop safety, and fail-open tradeoffs.
