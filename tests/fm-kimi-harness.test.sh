...
test_existing_launch_templates_are_byte_pinned() {
  ...
  assert_source_line "        printf '%s' '__CODEXCAGE__ --worktree __WORKTREE__ --task-data-dir __TASKDATA__ --status-path __STATUS__ --fm-home __FMHOME__ -- codex __MODELFLAG____EFFORTFLAG__--dangerously-bypass-approvals-and-sandbox \"\$(__OPINPUT__ encode launch-brief < __BRIEF__)\"'"
  assert_source_line "        printf '%s' '__CODEXCAGE__ --worktree __WORKTREE__ --task-data-dir __TASKDATA__ --status-path __STATUS__ --notify-path __TURNEND__ --fm-home __FMHOME__ -- codex __MODELFLAG____EFFORTFLAG__--dangerously-bypass-approvals-and-sandbox -c \"notify=[\\\"bash\\\",\\\"-c\\\",\\\"touch __TURNEND__\\\"]\" \"\$(__OPINPUT__ encode launch-brief < __BRIEF__)\"'"
