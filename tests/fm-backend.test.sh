...
# fm-delivery-lib.sh and fm-operational-input.sh are copied siblings because the
# fork's teardown and marker compatibility paths source them unconditionally.
