...
printf 'ok - Pi %s live E2E covered native Calm Working visibility, Ahoy boundaries, visible escalation relay, triggered handling, drain, legacy transcripts, near misses, and watcher continuity\n' "$PI_VERSION"
