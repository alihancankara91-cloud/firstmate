...
The shared predicate covers both missing supervision and undrained home-local worker escalations, so adapter preambles preserve its concrete stderr reason.
